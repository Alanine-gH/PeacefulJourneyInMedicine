			...
			setServiceData(index) {
				const serviceList = [{
					...
					},
					{
						...
						icon: '🚑',
						navColor: '#4CAF50',
						navGradient: 'linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%)',
						bannerColor: '#4CAF50',
						bannerGradient: 'linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%)',
						numberColor: '#4CAF50',
						numberGradient: 'linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%)',
						arrowColor: '#4CAF50',
						priceColor: '#FF6B6B',
						noticeBorderColor: '#4CAF50',
						noticeBgColor: '#E8F5E9',
						services: [{
								icon: '👨‍⚕️',
								text: '全程陪同'
							},
					...
					},
					{
						...
						icon: '💬',
						navColor: '#2196F3',
						navGradient: 'linear-gradient(135deg, #2196F3 0%, #1976D2 100%)',
						bannerColor: '#2196F3',
						bannerGradient: 'linear-gradient(135deg, #2196F3 0%, #1976D2 100%)',
						numberColor: '#2196F3',
						numberGradient: 'linear-gradient(135deg, #2196F3 0%, #1976D2 100%)',
						arrowColor: '#2196F3',
						priceColor: '#FF6B6B',
						noticeBorderColor: '#2196F3',
