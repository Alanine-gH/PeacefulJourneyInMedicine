...
-- ----------------------------
DROP TABLE IF EXISTS `redis_cache_key`;
CREATE TABLE `redis_cache_key`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID，自增',
  `redis_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Redis Key名称',
  `redis_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据类型（string、hash、list、set、zset）',
  `key_description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Key描述',
  `expire_seconds` int NULL DEFAULT -1 COMMENT '过期时间（秒，-1表示永不过期）',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '修改人',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '描述信息',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `redis_key`(`redis_key` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Redis缓存Key设计表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of redis_cache_key
-- ----------------------------
INSERT INTO `redis_cache_key` VALUES (1, 'user:token:{user_id}', 'string', '用户Token', 604800, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '7天过期');
INSERT INTO `redis_cache_key` VALUES (2, 'user:session:{session_id}', 'hash', '用户会话信息', 1800, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '30分钟过期');
INSERT INTO `redis_cache_key` VALUES (3, 'user:info:{user_id}', 'hash', '用户基本信息缓存', 3600, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '1小时过期');
INSERT INTO `redis_cache_key` VALUES (4, 'order:cache:{order_id}', 'hash', '订单详情缓存', 300, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '5分钟过期');
INSERT INTO `redis_cache_key` VALUES (5, 'order:list:{user_id}', 'list', '用户订单列表缓存', 600, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '10分钟过期');
INSERT INTO `redis_cache_key` VALUES (6, 'accompanist:info:{accompanist_id}', 'hash', '陪诊师信息缓存', 3600, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '1小时过期');
INSERT INTO `redis_cache_key` VALUES (7, 'accompanist:available:{city}:{date}', 'set', '可用陪诊师集合', 86400, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '1天过期');
INSERT INTO `redis_cache_key` VALUES (8, 'hospital:info:{hospital_id}', 'hash', '医院信息缓存', 86400, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '24小时过期');
INSERT INTO `redis_cache_key` VALUES (9, 'expert:list:{department_id}:{hospital_id}', 'list', '专家列表缓存', 3600, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '1小时过期');
INSERT INTO `redis_cache_key` VALUES (10, 'package:list:{type}', 'list', '服务套餐列表缓存', 3600, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '1小时过期');
INSERT INTO `redis_cache_key` VALUES (11, 'config:{config_key}', 'string', '系统配置缓存', 86400, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '24小时过期');
INSERT INTO `redis_cache_key` VALUES (12, 'rate:limit:{ip}:{api}', 'string', '接口限流计数', 60, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '1分钟过期');
INSERT INTO `redis_cache_key` VALUES (13, 'sms:code:{phone}:{type}', 'string', '短信验证码', 300, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '5分钟过期');
INSERT INTO `redis_cache_key` VALUES (14, 'email:code:{email}:{type}', 'string', '邮箱验证码', 300, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '5分钟过期');
...
-- ----------------------------
-- Table structure for service_checkin
-- ----------------------------
DROP TABLE IF EXISTS `service_checkin`;
CREATE TABLE `service_checkin`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID，自增',
  `order_id` bigint NOT NULL COMMENT '订单ID，关联order_order表',
  `accompanist_id` bigint NOT NULL COMMENT '陪诊师ID，关联user_accompanist表',
  `checkin_type` tinyint NULL DEFAULT NULL COMMENT '打卡类型（1：接机；2：送机；3：到达医院；4：进入诊室；5：检查结束；6：就诊结束；7：其他）',
  `checkin_location` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '打卡位置',
  `checkin_photos` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '打卡照片（多个用逗号分隔，存储在MinIO）',
  `checkin_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '打卡描述',
  `latitude` decimal(10, 6) NULL DEFAULT NULL COMMENT '纬度',
  `longitude` decimal(10, 6) NULL DEFAULT NULL COMMENT '经度',
  `checkin_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '打卡时间',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '修改人',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '打卡记录表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of service_checkin
-- ----------------------------
INSERT INTO `service_checkin` VALUES (1, 1, 7, 3, '北京协和医院东院门口', 'https://example.com/checkin/1_1.jpg', '已到达医院，等待患者', 39.913918, 116.409286, '2026-03-10 07:55:00', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '到达医院');
INSERT INTO `service_checkin` VALUES (2, 1, 7, 4, '北京协和医院神经科门诊3楼', 'https://example.com/checkin/1_2.jpg', '已进入诊室区域', 39.913918, 116.409286, '2026-03-10 09:10:00', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '进入诊室');
INSERT INTO `service_checkin` VALUES (3, 1, 7, 6, '北京协和医院神经科门诊', 'https://example.com/checkin/1_3.jpg,https://example.com/checkin/1_4.jpg', '就诊完成，医生建议注意休息', 39.913918, 116.409286, '2026-03-10 16:45:00', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '就诊结束');
INSERT INTO `service_checkin` VALUES (4, 5, 9, 3, '北京大学第一医院骨科门诊', 'https://example.com/checkin/5_1.jpg', '已到达医院', 39.913252, 116.373737, '2026-03-05 09:55:00', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '到达医院');
INSERT INTO `service_checkin` VALUES (5, 5, 9, 6, '北京大学第一医院', 'https://example.com/checkin/5_2.jpg', '手续办理完成', 39.913252, 116.373737, '2026-03-05 13:50:00', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '完成');
INSERT INTO `service_checkin` VALUES (6, 6, 7, 1, '北京首都机场T3航站楼', 'https://example.com/checkin/6_1.jpg', '已接到患者', 40.079885, 116.603133, '2026-03-01 14:15:00', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '接机成功');
INSERT INTO `service_checkin` VALUES (7, 1, 1, 3, '北京协和医院东院门口', 'https://example.com/checkin/1_1.jpg', '已到达医院，等待患者', 39.913918, 116.409286, '2026-03-10 07:55:00', 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '到达医院');
INSERT INTO `service_checkin` VALUES (8, 1, 1, 4, '北京协和医院神经科门诊3楼', 'https://example.com/checkin/1_2.jpg', '已进入诊室区域', 39.913918, 116.409286, '2026-03-10 09:10:00', 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '进入诊室');
INSERT INTO `service_checkin` VALUES (9, 1, 1, 6, '北京协和医院神经科门诊', 'https://example.com/checkin/1_3.jpg,https://example.com/checkin/1_4.jpg', '就诊完成，医生建议注意休息', 39.913918, 116.409286, '2026-03-10 16:45:00', 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '就诊结束');
INSERT INTO `service_checkin` VALUES (10, 5, 3, 3, '北京大学第一医院骨科门诊', 'https://example.com/checkin/5_1.jpg', '已到达医院', 39.913252, 116.373737, '2026-03-05 09:55:00', 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '到达医院');
INSERT INTO `service_checkin` VALUES (11, 5, 3, 6, '北京大学第一医院', 'https://example.com/checkin/5_2.jpg', '手续办理完成', 39.913252, 116.373737, '2026-03-05 13:50:00', 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '完成');
INSERT INTO `service_checkin` VALUES (12, 6, 1, 1, '北京首都机场T3航站楼', 'https://example.com/checkin/6_1.jpg', '已接到患者', 40.079885, 116.603133, '2026-03-01 14:15:00', 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '接机成功');
...
) ENGINE = InnoDB AUTO_INCREMENT = 69 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '字典表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES (1, 'user_type', '患者', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '患者用户类型');
INSERT INTO `sys_dict` VALUES (2, 'user_type', '陪诊师', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师用户类型');
INSERT INTO `sys_dict` VALUES (3, 'user_type', '客服', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '客服用户类型');
INSERT INTO `sys_dict` VALUES (4, 'user_type', '管理员', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '管理员用户类型');
INSERT INTO `sys_dict` VALUES (5, 'account_status', '活跃', '1', 1, 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '账号活跃状态');
INSERT INTO `sys_dict` VALUES (6, 'account_status', '停用', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '账号停用状态');
INSERT INTO `sys_dict` VALUES (7, 'account_status', '禁用', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '账号禁用状态');
INSERT INTO `sys_dict` VALUES (8, 'order_status', '待付款', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单待付款');
INSERT INTO `sys_dict` VALUES (9, 'order_status', '已付款', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单已付款');
INSERT INTO `sys_dict` VALUES (10, 'order_status', '已确认', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单已确认');
INSERT INTO `sys_dict` VALUES (11, 'order_status', '服务中', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单服务中');
INSERT INTO `sys_dict` VALUES (12, 'order_status', '已完成', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单已完成');
INSERT INTO `sys_dict` VALUES (13, 'order_status', '已取消', '6', 6, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单已取消');
INSERT INTO `sys_dict` VALUES (14, 'order_status', '退款中', '7', 7, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单退款中');
INSERT INTO `sys_dict` VALUES (15, 'order_status', '已退款', '8', 8, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单已退款');
INSERT INTO `sys_dict` VALUES (16, 'order_type', '全程陪诊', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '全程陪诊服务');
INSERT INTO `sys_dict` VALUES (17, 'order_type', '代办手续', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '代办手续服务');
INSERT INTO `sys_dict` VALUES (18, 'order_type', '接机服务', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '接机服务');
INSERT INTO `sys_dict` VALUES (19, 'order_type', '送机服务', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '送机服务');
INSERT INTO `sys_dict` VALUES (20, 'payment_status', '待支付', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '支付待支付');
INSERT INTO `sys_dict` VALUES (21, 'payment_status', '支付中', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '支付中');
INSERT INTO `sys_dict` VALUES (22, 'payment_status', '支付成功', '3', 3, 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '支付成功');
INSERT INTO `sys_dict` VALUES (23, 'payment_status', '支付失败', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '支付失败');
INSERT INTO `sys_dict` VALUES (24, 'payment_status', '已退款', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '已退款');
INSERT INTO `sys_dict` VALUES (25, 'payment_method', '信用卡', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '信用卡支付');
INSERT INTO `sys_dict` VALUES (26, 'payment_method', '支付宝', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '支付宝支付');
INSERT INTO `sys_dict` VALUES (27, 'payment_method', '微信支付', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '微信支付');
INSERT INTO `sys_dict` VALUES (28, 'payment_method', 'Stripe', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', 'Stripe支付');
INSERT INTO `sys_dict` VALUES (29, 'payment_method', 'Adyen', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', 'Adyen支付');
INSERT INTO `sys_dict` VALUES (30, 'payment_method', '银行转账', '6', 6, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '银行转账');
INSERT INTO `sys_dict` VALUES (31, 'accompany_status', '空闲', '1', 1, 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师空闲');
INSERT INTO `sys_dict` VALUES (32, 'accompany_status', '服务中', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师服务中');
INSERT INTO `sys_dict` VALUES (33, 'accompany_status', '休假', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师休假');
INSERT INTO `sys_dict` VALUES (34, 'accompany_status', '停用', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师停用');
INSERT INTO `sys_dict` VALUES (35, 'audit_status', '待审核', '1', 1, 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '待审核');
INSERT INTO `sys_dict` VALUES (36, 'audit_status', '已通过', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '已通过');
INSERT INTO `sys_dict` VALUES (37, 'audit_status', '已拒绝', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '已拒绝');
INSERT INTO `sys_dict` VALUES (38, 'triage_status', '待分诊', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '待分诊');
INSERT INTO `sys_dict` VALUES (39, 'triage_status', 'AI分诊中', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', 'AI分诊中');
INSERT INTO `sys_dict` VALUES (40, 'triage_status', 'AI分诊完成', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', 'AI分诊完成');
INSERT INTO `sys_dict` VALUES (41, 'triage_status', '待人工复审', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '待人工复审');
INSERT INTO `sys_dict` VALUES (42, 'triage_status', '人工复审完成', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '人工复审完成');
INSERT INTO `sys_dict` VALUES (43, 'triage_status', '已生成方案', '6', 6, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '已生成方案');
INSERT INTO `sys_dict` VALUES (44, 'appointment_status', '待确认', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '预约待确认');
INSERT INTO `sys_dict` VALUES (45, 'appointment_status', '已确认', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '预约已确认');
INSERT INTO `sys_dict` VALUES (46, 'appointment_status', '已取消', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '预约已取消');
INSERT INTO `sys_dict` VALUES (47, 'appointment_status', '已完成', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '预约已完成');
INSERT INTO `sys_dict` VALUES (48, 'appointment_status', '已过期', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '预约已过期');
INSERT INTO `sys_dict` VALUES (49, 'department_type', '内科', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '内科');
INSERT INTO `sys_dict` VALUES (50, 'department_type', '外科', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '外科');
INSERT INTO `sys_dict` VALUES (51, 'department_type', '妇产科', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '妇产科');
INSERT INTO `sys_dict` VALUES (52, 'department_type', '儿科', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '儿科');
INSERT INTO `sys_dict` VALUES (53, 'department_type', '眼科', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '眼科');
INSERT INTO `sys_dict` VALUES (54, 'department_type', '耳鼻喉科', '6', 6, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '耳鼻喉科');
INSERT INTO `sys_dict` VALUES (55, 'department_type', '皮肤科', '7', 7, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '皮肤科');
INSERT INTO `sys_dict` VALUES (56, 'department_type', '骨科', '8', 8, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '骨科');
INSERT INTO `sys_dict` VALUES (57, 'department_type', '神经科', '9', 9, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '神经科');
INSERT INTO `sys_dict` VALUES (58, 'department_type', '其他', '10', 10, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '其他科室');
INSERT INTO `sys_dict` VALUES (59, 'hospital_type', '三甲医院', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '三甲医院');
INSERT INTO `sys_dict` VALUES (60, 'hospital_type', '二甲医院', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '二甲医院');
INSERT INTO `sys_dict` VALUES (61, 'hospital_type', '专科医院', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '专科医院');
INSERT INTO `sys_dict` VALUES (62, 'hospital_type', '国际医院', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '国际医院');
INSERT INTO `sys_dict` VALUES (63, 'file_category', '病历资料', '1', 1, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '病历资料');
INSERT INTO `sys_dict` VALUES (64, 'file_category', '证件照片', '2', 2, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '证件照片');
INSERT INTO `sys_dict` VALUES (65, 'file_category', '证书资质', '3', 3, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '证书资质');
INSERT INTO `sys_dict` VALUES (66, 'file_category', '评价图片', '4', 4, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '评价图片');
INSERT INTO `sys_dict` VALUES (67, 'file_category', '打卡照片', '5', 5, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '打卡照片');
INSERT INTO `sys_dict` VALUES (68, 'file_category', '系统文件', '6', 6, 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '系统文件');
...
CREATE TABLE `user_permission`  (
  ...
  `permission_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限编码，唯一索引',
  `permission_type` tinyint NULL DEFAULT NULL COMMENT '权限类型（1：目录；2：菜单；3：按钮）',
  `permission_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限URL',
...
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '权限表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user_permission
-- ----------------------------
INSERT INTO `user_permission` VALUES (1, 0, '系统管理', 'system', 1, '/system', '', 'Setting', 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '系统管理菜单');
INSERT INTO `user_permission` VALUES (2, 1, '用户管理', 'user_manage', 2, '/system/user', 'system/user/index', 'User', 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '用户管理');
INSERT INTO `user_permission` VALUES (3, 1, '角色管理', 'role_manage', 2, '/system/role', 'system/role/index', 'Role', 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '角色管理');
INSERT INTO `user_permission` VALUES (4, 1, '权限管理', 'permission_manage', 2, '/system/permission', 'system/permission/index', 'Permission', 3, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '权限管理');
INSERT INTO `user_permission` VALUES (5, 0, '订单管理', 'order', 1, '/order', '', 'ShoppingCart', 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单管理菜单');
INSERT INTO `user_permission` VALUES (6, 5, '订单列表', 'order_list', 2, '/order/list', 'order/list/index', 'List', 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单列表');
INSERT INTO `user_permission` VALUES (7, 5, '订单详情', 'order_detail', 2, '/order/detail', 'order/detail/index', 'Detail', 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '订单详情');
INSERT INTO `user_permission` VALUES (8, 0, '医疗管理', 'medical', 1, '/medical', '', 'Hospital', 3, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '医疗管理菜单');
INSERT INTO `user_permission` VALUES (9, 8, '医院管理', 'hospital_manage', 2, '/medical/hospital', 'medical/hospital/index', 'Hospital', 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '医院管理');
INSERT INTO `user_permission` VALUES (10, 8, '专家管理', 'expert_manage', 2, '/medical/expert', 'medical/expert/index', 'User', 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '专家管理');
INSERT INTO `user_permission` VALUES (11, 0, '陪诊师管理', 'accompanist', 1, '/accompanist', '', 'Team', 4, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师管理菜单');
INSERT INTO `user_permission` VALUES (12, 11, '陪诊师列表', 'accompanist_list', 2, '/accompanist/list', 'accompanist/list/index', 'List', 1, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师列表');
INSERT INTO `user_permission` VALUES (13, 11, '陪诊师审核', 'accompanist_audit', 2, '/accompanist/audit', 'accompanist/audit/index', 'Check', 2, 1, 'admin', '2026-03-18 11:59:29', NULL, '2026-03-18 11:59:29', '陪诊师审核');
INSERT INTO `user_permission` VALUES (50, 1, '用户管理', 'system:user', 2, '/system/user', 'system/user/index', 'User', 1, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '用户管理菜单');
INSERT INTO `user_permission` VALUES (51, 1, '角色管理', 'system:role', 2, '/system/role', 'system/role/index', 'Role', 2, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '角色管理菜单');
INSERT INTO `user_permission` VALUES (52, 1, '权限管理', 'system:permission', 2, '/system/permission', 'system/permission/index', 'Lock', 3, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '权限管理菜单');
INSERT INTO `user_permission` VALUES (53, 5, '订单列表', 'order:list', 2, '/order/list', 'order/list/index', 'List', 1, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '订单列表菜单');
INSERT INTO `user_permission` VALUES (54, 5, '订单详情', 'order:detail', 3, '/order/detail', 'order/detail/index', 'View', 2, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '订单详情按钮');
INSERT INTO `user_permission` VALUES (55, 8, '分诊管理', 'medical:triage', 2, '/medical/triage', 'medical/triage/index', 'FirstAidKit', 1, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '分诊管理菜单');
INSERT INTO `user_permission` VALUES (56, 8, '医院管理', 'medical:hospital', 2, '/medical/hospital', 'medical/hospital/index', 'OfficeBuilding', 2, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '医院管理菜单');
INSERT INTO `user_permission` VALUES (57, 8, '专家管理', 'medical:expert', 2, '/medical/expert', 'medical/expert/index', 'FirstAidKit', 3, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '专家管理菜单');
INSERT INTO `user_permission` VALUES (58, 0, '服务管理', 'service', 1, '/service', 'Layout', 'Service', 4, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '服务管理目录');
INSERT INTO `user_permission` VALUES (59, 12, '套餐管理', 'service:package', 2, '/service/package', 'service/package/index', 'Gift', 1, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '套餐管理菜单');
INSERT INTO `user_permission` VALUES (60, 12, '日程管理', 'service:schedule', 2, '/service/schedule', 'service/schedule/index', 'Calendar', 2, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '日程管理菜单');
INSERT INTO `user_permission` VALUES (61, 0, '财务管理', 'finance', 1, '/finance', 'Layout', 'Wallet', 5, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '财务管理目录');
INSERT INTO `user_permission` VALUES (62, 15, '支付记录', 'finance:payment', 2, '/finance/payment', 'finance/payment/index', 'CreditCard', 1, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '支付记录菜单');
INSERT INTO `user_permission` VALUES (63, 0, '统计分析', 'statistics', 1, '/statistics', 'Layout', 'DataAnalysis', 6, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '统计分析目录');
INSERT INTO `user_permission` VALUES (64, 17, '数据统计', 'statistics:data', 2, '/statistics/data', 'statistics/data/index', 'PieChart', 1, 1, 'system', '2026-03-18 12:06:05', NULL, '2026-03-18 12:06:05', '数据统计菜单');
...
-- ----------------------------
-- Table structure for value_added_order
-- ----------------------------
...
CREATE TABLE `value_added_order`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID，关联user_user表',
  `user_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '用户姓名（冗余）',
  `user_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '用户手机号（冗余）',
  `service_type` tinyint NULL DEFAULT NULL COMMENT '服务类型（1：病历翻译；2：处方解读；3：远程随访；4：视频复诊；5：术后康养）',
  `order_status` tinyint NULL DEFAULT 1 COMMENT '订单状态（1：待付款；2：已付款；3：服务中；4：已完成；5：已取消）',
  `original_order_id` bigint NULL DEFAULT NULL COMMENT '原订单ID，关联order_order表',
  `service_fee` decimal(10, 2) NULL DEFAULT NULL COMMENT '服务费用',
  `currency` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'USD' COMMENT '货币类型',
  `service_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '服务内容描述',
  `delivery_time` datetime NULL DEFAULT NULL COMMENT '交付时间',
  `completion_time` datetime NULL DEFAULT NULL COMMENT '完成时间',
  `file_urls` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '交付文件URL',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '修改人',
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  ...
  INDEX `idx_service_type`(`service_type` ASC) USING BTREE,
  INDEX `idx_order_status`(`order_status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '增值服务订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of value_added_order
-- ----------------------------
INSERT INTO `value_added_order` VALUES (1, 'VA20260301001', 1, '张三', '+86 13800138001', 1, 4, 1, 150.00, 'USD', '病历翻译服务-神经科就诊记录翻译', '2026-03-12 18:00:00', '2026-03-14 15:00:00', 'https://example.com/va/translation_1.pdf', 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '已完成');
INSERT INTO `value_added_order` VALUES (2, 'VA20260302002', 4, 'John Doe', '+1 5551234567', 2, 3, 3, 200.00, 'USD', '处方解读服务-Mayo Clinic处方分析', '2026-03-20 18:00:00', NULL, NULL, 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '服务中');
INSERT INTO `value_added_order` VALUES (3, 'VA20260303003', 2, '李四', '+86 13800138002', 4, 1, 2, 300.00, 'USD', '视频复诊服务-消化内科专家复诊', '2026-03-22 14:00:00', NULL, NULL, 'system', '2026-03-18 12:01:09', NULL, '2026-03-18 12:01:09', '待付款');
